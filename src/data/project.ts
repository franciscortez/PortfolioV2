...
export const projects: Project[] = [
  {
    ...
    images: [
      {
        src: "/images/projects/tax-traq.webp",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/projects/gentlemens-quarter.webp",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/projects/nola-paymongo.webp",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/projects/penny-wings.webp",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/projects/google-inbox.webp",
  ...
  },
  {
    ...
    subtitle: "Personal Project",
    summary:
      "Watches OnlineJobs.ph for matching developer roles and keeps the good fits in a Google Sheet with scores and application tracking.",
    explanation:
      "Google Apps Script reads enabled searches, checks up to 50 job pages per run, and scores matches on skills like Next.js, Supabase, and Claude Code. Open roles land in employment-type tabs with match score, reason, and location, while Applied rows move to Applications and unapplied discovery rows expire after 14 days. A Runs tab logs each execution.",
    features: [
      "Scheduled hourly refresh plus manual Run now from the sheet menu",
      "Skill scoring with match reason and location per job",
      "Open-role filtering with closed and bad-fit jobs hidden",
      "Application tracking with permanent Applications history",
      "Per-run diary with added counts and error reporting",
      "Structured JSON execution logs per run",
    ],
    tags: ["Automation", "Google Apps Script", "Job Search"],
    tech: [
      {
        name: "Google Apps Script",
        icon: "googleAppsScript",
    ...
    links: [
      {
        label: "View Code",
        href: "https://github.com/franciscortez/job-scrapper",
        type: "github",
      },
    ],
    images: [
      {
        src: "/images/projects/olj-scraper.webp",
        alt: "Job Tracker Google Sheet showing matched OnlineJobs.ph roles with salary and employment type",
        description:
          "Part Time tab of the Job Tracker sheet listing matched OnlineJobs.ph roles with job links, salary text, employment type, and posted dates.",
      },
    ],
    category: "automation",
  },
  {
    ...
    images: [
      {
        src: "/images/projects/twitch-insight.webp",
