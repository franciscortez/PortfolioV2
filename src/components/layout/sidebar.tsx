...
export function Sidebar({
  ...
  return (
    <aside
      ...
      className={`${className} grid-rows-[auto_auto] content-start gap-3 bg-background p-3 transition-colors sm:p-4 lg:sticky lg:top-0 lg:h-dvh lg:min-h-dvh lg:grid-rows-[minmax(0,45fr)_minmax(0,65fr)] lg:content-normal lg:gap-4 lg:overflow-hidden xl:gap-5 massive:gap-6`}
    >
...
function SidebarProfile({
  ...
  return (
    <div className="relative flex min-w-0 flex-col justify-center border border-border bg-panel px-5 py-6 sm:px-5 sm:py-5 lg:min-h-0 lg:overflow-hidden lg:px-3 lg:py-3 xl:px-4 xl:py-4 massive:px-6 massive:py-6">
      <ThemeToggle
